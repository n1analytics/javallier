...
//	public static final int FLOAT_MAX_PRECISION = 277;
	 ...
	 * @return The encoded number.
 	 ...
 	 */
	public static Number encodeToPrecision(BigInteger value, int precision) throws
	 ...
	 * @throws IllegalArgumentException If {@code precision} is less than 1.
	 */
	public static Number encodeToPrecision(long value, int precision) throws
		IllegalArgumentException
	{
		// TODO optimise
	...
	public static Number encode(double value) throws EncodeException {
		return encodeToPrecision(
			value,
			FloatingPointUtil.DOUBLE_FRACTION_BITS + 1);
	}
	...
	public static Number encodeToExponent(double value, int exponent) {
		...
		return new Number(
			n.significand.shiftLeft(n.getExponent() - exponent),
			exponent);
	}
	 ...
	 * @throws IllegalArgumentException If {@code precision} is less than 1.
	 */
	public static Number encodeToPrecision(double value, int precision) throws
		EncodeException,
		IllegalArgumentException
	{
		if(precision < 1)
	...
	public Number add(Number other) {
		...
		if(exponent < other.exponent)
			return new Number(
				significand.add(
					other.significand.shiftLeft(other.exponent - exponent)),
				exponent);
		return new Number(
			other.significand.add(
				significand.shiftLeft(exponent - other.exponent)),
			other.exponent);
	}
	...
	public Number multiply(Number other) {
		return new Number(
			significand.multiply(other.significand),
	...
	*/
	...
	public String toString() {
		return String.format(
			"Number(exponent=%d, significand=%X)",
			exponent,
			significand);
	}
