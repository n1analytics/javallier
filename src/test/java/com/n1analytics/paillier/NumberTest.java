...
public class NumberTest {
  ...
  public void testPositiveEpsilon() throws Exception {
    assertEquals(Math.pow(2.0, -100.0), Number.positiveEpsilon(-100).decodeDouble(),
                 EPSILON);
    assertEquals(Math.pow(2.0, -10.0), Number.positiveEpsilon(-10).decodeDouble(),
                 EPSILON);
  ...
  public void testNegativeEpsilon() throws Exception {
    assertEquals(-1 * Math.pow(2.0, -100.0), Number.negativeEpsilon(-100).decodeDouble(),
                 EPSILON);
    assertEquals(-1 * Math.pow(2.0, -10.0), Number.negativeEpsilon(-10).decodeDouble(),
                 EPSILON);
    assertEquals(-1 * Math.pow(2.0, -1.0), Number.negativeEpsilon(-1).decodeDouble(),
                 EPSILON);
    assertEquals(-1 * Math.pow(2.0, 0.0), Number.negativeEpsilon(0).decodeDouble(),
                 EPSILON);
    assertEquals(-1 * Math.pow(2.0, 1.0), Number.negativeEpsilon(1).decodeDouble(),
                 EPSILON);
    assertEquals(-1 * Math.pow(2.0, 10.0), Number.negativeEpsilon(10).decodeDouble(),
  ...
  public void testInfinityDouble() throws Exception {
    ...
    assertEquals(Double.NEGATIVE_INFINITY,
                 veryLargeNegativeNumber.decodeApproximateDouble(), EPSILON);
    ...
    assertEquals(Double.POSITIVE_INFINITY,
                 veryLargePositiveNumber.decodeApproximateDouble(), EPSILON);
  }
  ...
  public void testEncodeToExponentDecodeDouble(double value, int exponent) {
    double decodedResult = Number.encodeToExponent(value,
                                                   exponent).decodeApproximateDouble();
  ...
  public void testEncodeToExponentDecodeBigInteger(BigInteger value, int exponent) {
    BigInteger decodedResult = Number.encodeToExponent(value,
                                                       exponent).decodeApproximateBigInteger();
