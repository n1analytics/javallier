...
public class AdditionTest {
    ...
    interface BinaryAdder1 extends TwoInputsFunction<EncryptedNumber, EncryptedNumber, EncryptedNumber> {
        public EncryptedNumber eval(EncryptedNumber arg1, EncryptedNumber arg2);
    };

    interface BinaryAdder2 extends TwoInputsFunction<EncryptedNumber, EncodedNumber, EncryptedNumber> {
        public EncryptedNumber eval(EncryptedNumber arg1, EncodedNumber arg2);
    };

    interface BinaryAdder3 extends TwoInputsFunction<EncryptedNumber, Number, EncryptedNumber> {
        public EncryptedNumber eval(EncryptedNumber arg1, Number arg2);
    };

    interface BinaryAdder4 extends TwoInputsFunction<EncodedNumber, EncodedNumber, EncodedNumber> {
    ...
    BinaryAdder1 binaryAdders1[] = new BinaryAdder1[] {
            new BinaryAdder1() {
                @Override
                public EncryptedNumber eval(EncryptedNumber arg1, EncryptedNumber arg2) {
    ...
    BinaryAdder2 binaryAdders2[] = new BinaryAdder2[] {
            new BinaryAdder2() {
                @Override
                public EncryptedNumber eval(EncryptedNumber arg1, EncodedNumber arg2) {
                    return arg1.add(arg2);
    ...
    BinaryAdder3 binaryAdders3[] = new BinaryAdder3[] {
            new BinaryAdder3() {
                @Override
                public EncryptedNumber eval(EncryptedNumber arg1, Number arg2) {
                    return arg1.add(arg2);
    ...
    BinaryAdder4 binaryAdders4[] = new BinaryAdder4[] {
            new BinaryAdder4() {
                @Override
                public EncodedNumber eval(EncodedNumber arg1, EncodedNumber arg2) {
                    return arg1.add(arg2);
    ...
    BinaryAdder5 binaryAdders5[] = new BinaryAdder5[] {
            new BinaryAdder5() {
                @Override
                public EncodedNumber eval(EncodedNumber arg1, Number arg2) {
                    return arg1.add(arg2);
    ...
    BinaryAdder6 binaryAdders6[] = new BinaryAdder6[] {
            new BinaryAdder6() {
                @Override
                public Number eval(Number arg1, Number arg2) {
                    return arg1.add(arg2);
