...
//			1+Number.FLOAT_MAX_PRECISION);
	...
	public static final PaillierPrivateKey PRIVATE_KEY_DOUBLE =
		PaillierPrivateKey.create(2104);
	public static final TestConfiguration CONFIGURATION_DOUBLE =
		create(
			PRIVATE_KEY_DOUBLE,
			true,
			1+Number.DOUBLE_MAX_PRECISION);

	public static final PaillierPrivateKey PRIVATE_KEY_512 =
		PaillierPrivateKey.create(512);
	public static final TestConfiguration UNSIGNED_FULL_PRECISION_512 =
		createUnsignedFullPrecision(PRIVATE_KEY_512);
	public static final TestConfiguration UNSIGNED_PARTIAL_PRECISION_512 =
		createUnsignedPartialPrecision(PRIVATE_KEY_512);
	public static final TestConfiguration SIGNED_FULL_PRECISION_512 =
		createSignedFullPrecision(PRIVATE_KEY_512);
	public static final TestConfiguration SIGNED_PARTIAL_PRECISION_512 =
		createSignedPartialPrecision(PRIVATE_KEY_512);
	public static final TestConfiguration[] CONFIGURATION_512 = {
		UNSIGNED_FULL_PRECISION_512,
		UNSIGNED_PARTIAL_PRECISION_512,
		SIGNED_FULL_PRECISION_512,
		SIGNED_PARTIAL_PRECISION_512
	};
	
	public static final PaillierPrivateKey PRIVATE_KEY_1024 =
		PaillierPrivateKey.create(1024);
	public static final TestConfiguration UNSIGNED_FULL_PRECISION_1024 =
		createUnsignedFullPrecision(PRIVATE_KEY_1024);
	public static final TestConfiguration UNSIGNED_PARTIAL_PRECISION_1024 =
		createUnsignedPartialPrecision(PRIVATE_KEY_1024);
	public static final TestConfiguration SIGNED_FULL_PRECISION_1024 =
		createSignedFullPrecision(PRIVATE_KEY_1024);
	public static final TestConfiguration SIGNED_PARTIAL_PRECISION_1024 =
		createSignedPartialPrecision(PRIVATE_KEY_1024);
	public static final TestConfiguration[] CONFIGURATION_1024 = {
		UNSIGNED_FULL_PRECISION_1024,
		UNSIGNED_PARTIAL_PRECISION_1024,
		SIGNED_FULL_PRECISION_1024,
		SIGNED_PARTIAL_PRECISION_1024
	};
	
	public static final PaillierPrivateKey PRIVATE_KEY_2048 =
		PaillierPrivateKey.create(2048);
	public static final TestConfiguration UNSIGNED_FULL_PRECISION_2048 =
		createUnsignedFullPrecision(PRIVATE_KEY_2048);
	public static final TestConfiguration UNSIGNED_PARTIAL_PRECISION_2048 =
		createUnsignedPartialPrecision(PRIVATE_KEY_2048);
	public static final TestConfiguration SIGNED_FULL_PRECISION_2048 =
		createSignedFullPrecision(PRIVATE_KEY_2048);
	public static final TestConfiguration SIGNED_PARTIAL_PRECISION_2048 =
		createSignedPartialPrecision(PRIVATE_KEY_2048);
	public static final TestConfiguration[] CONFIGURATION_2048 = {
		UNSIGNED_FULL_PRECISION_2048,
		UNSIGNED_PARTIAL_PRECISION_2048,
		SIGNED_FULL_PRECISION_2048,
		SIGNED_PARTIAL_PRECISION_2048
	};
	...
	*/
	...
	public static final TestConfiguration UNSIGNED_FULL_PRECISION =
		UNSIGNED_FULL_PRECISION_1024;
	public static final TestConfiguration UNSIGNED_PARTIAL_PRECISION =
		UNSIGNED_PARTIAL_PRECISION_1024;
	public static final TestConfiguration SIGNED_FULL_PRECISION =
		SIGNED_FULL_PRECISION_1024;
	public static final TestConfiguration SIGNED_PARTIAL_PRECISION =
		SIGNED_PARTIAL_PRECISION_1024;	
...
//		new TestConfiguration[] {CONFIGURATION_FLOAT},
		new TestConfiguration[] {CONFIGURATION_DOUBLE},
		CONFIGURATION_512,
		CONFIGURATION_1024,
		CONFIGURATION_2048
	};
		...
		int precision)
	{
		...
		PaillierContext context = new PaillierContext(
	...
	public static TestConfiguration createUnsignedFullPrecision(PaillierPrivateKey privateKey) {
	...
	public static TestConfiguration createUnsignedPartialPrecision(PaillierPrivateKey privateKey) {
		int modulusLength = privateKey.getPublicKey().getModulus().bitLength();
		return create(modulusLength, false, modulusLength - 2);
	}
	...
	public static TestConfiguration createSignedFullPrecision(PaillierPrivateKey privateKey) {
		int modulusLength = privateKey.getPublicKey().getModulus().bitLength();
		return create(modulusLength, true, modulusLength);
	}
	...
	public static TestConfiguration createSignedPartialPrecision(PaillierPrivateKey privateKey) {
		int modulusLength = privateKey.getPublicKey().getModulus().bitLength();
		return create(modulusLength, true, modulusLength - 2);
	}
