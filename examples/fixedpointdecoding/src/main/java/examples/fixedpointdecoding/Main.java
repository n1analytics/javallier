...
public class Main {
  ...
  public static void print(String name, double value) {
    ...
    long bitsSignificandExplicit = bitsSignificand | ((0L < bitsExponentShifted && bitsExponentShifted < 0x7FFL) ? 0x0010000000000000L : 0L);
    ...
    if (mostSignificantBitExponent < DOUBLE_MIN_NORMAL_EXPONENT) {
      ...
      decodedSignificandExplicit = absSignificand.shiftLeft(
      ...
      decodedSignificandExplicit = absSignificand.shiftRight(
    ...
    System.out.format("%s:\n" +
                      ...
                      bitsSign, bitsSignShifted, bitsExponent, bitsExponentShifted,
                      bitsSignificand, bitsSignificandExplicit, decodedBits, decodedSign,
                      decodedSignShifted, decodedExponent, decodedExponentShifted,
                      decodedSignificand, decodedSignificandExplicit,
                      Double.doubleToLongBits(encoded.decodeDouble()),
                      absSignificandLength, mostSignificantBitExponent, exponent,
